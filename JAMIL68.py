...
def api4(ids,names,passlist):
    ...
    # 'cookie': 'datr=yoQsZx-dZlN_7hUSmuZwFm-m; sb=yoQsZ1ZsIK82gOu1MAmy-BqN; m_pixel_ratio=2; wd=360x701; fr=0JYUWZkGhNiEPQFHo..BnLITK..AAA.0.0.BnLITn.AWUc-k5xBUE',
    'dpr': '2',
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=U4MsZ3MsRQTgKYWUU2n7n43R; sb=U4MsZ1Z_8T4b9jU5DSPMvKYF; ps_l=1; ps_n=1; m_pixel_ratio=2; fr=0umtD4BFzL91OZNFs..BnLINU..AAA.0.0.BnLIOX.AWVBIrpIDd4; wd=891x1736; dpr=2.1988937854766846',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-mobile': '?0',
...
def Hamza1(ids,passlist):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=3YEsZ0KxdWEmkVjTxl6vBKAi; usida=eyJ2ZXIiOjEsImlkIjoiQXNta3AyNzFhNzRtMnAiLCJ0aW1lIjoxNzMwOTcwMDc5fQ%3D%3D; sb=6oEsZyNWB676l3Pek-f-kxY7; ps_l=1; ps_n=1; m_pixel_ratio=2; wd=360x701; fr=0u9Q5L7uKLx9jZ6p6..BnLIHq..AAA.0.0.BnLIIK.AWUqmMY7Lqk',
    'dpr': '2',
